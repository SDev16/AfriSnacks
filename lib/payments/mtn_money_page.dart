...
class _MtnPaymentPageState extends State<MtnPaymentPage> {
  ...
  // Replace with your actual MTN MoMo API credentials
  ...
  Future<bool> _onWillPop() async {
    ...
    final shouldExit = await showDialog<bool>(
      ...
      builder: (context) => AlertDialog(
        ...
        content: const Text('Are you sure you want to cancel the MTN MoMo payment?'),
        actions: [
          TextButton(
  ...
  Future<void> _processPayment() async {
    ...
    try {
      ...
      if (response.isOperationSuccess() && response.isTransactionSuccess()) {
        ...
        updatedOrderData['momoProvider'] = 'MTN';
      ...
      builder: (context) => AlertDialog(
        ...
        content: Column(
          ...
          children: [
            ...
            Text(
              'Your MTN MoMo payment of ${totalAmount.toStringAsFixed(0)} FCFA has been processed successfully.',
  ...
  String? _validatePhone(String? value) {
    if (value == null || value.isEmpty) {
      return 'Please enter your MTN phone number';
    }
    ...
    // MTN numbers in Cameroon typically start with 67, 68, 69
    final numberWithoutCountryCode = cleanNumber.replaceFirst(RegExp(r'^\+?237'), '');
    if (!RegExp(r'^6[789]\d{7}$').hasMatch(numberWithoutCountryCode)) {
      return 'Please enter a valid MTN number (67, 68, or 69)';
    }
      ...
      child: Scaffold(
        appBar: AppBar(
          ...
          leading: _isLoading 
              ? null 
              : IconButton(
                  icon: const Icon(Iconsax.stop,color: Colors.transparent,),
        ...
        body: Container(
          decoration: const BoxDecoration(
            gradient: LinearGradient(
              colors: [Color(0xFFFFD700), Color(0xFFFFA500)], // MTN Yellow/Orange gradient
